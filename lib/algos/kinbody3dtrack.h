...
namespace gcop {
  ...
  public:
     ...
     */
    void Optp(VectorXd &p, const vector<Matrix4d> &xs);

    void Get(Matrix4d &x, double vd, double t) const;

    void MakeTrue();

    void Add(const Vector6d &u, const Matrix4d &x, double h);
     ...
     * @param h time-step 
     */
    void Add2(const Vector6d &u, const Matrix4d &x, double h);
