...
{\bf \-Vectormd} {\bf p}
\begin{DoxyCompactList}\small\item\em static parameters (could be none) \end{DoxyCompactList}\end{DoxyCompactItemize}
...
the output stream template $<$typename \-T, int nx = \-Dynamic, int nu = \-Dynamic, int np = \-Dynamic, int \-\_\-ns = \-Dynamic$>$ std\-::ostream\& operator$<$$<$(std\-::ostream \&os, const gcop\-::\-Trajectory$<$\-T, nx, nu, np, \-\_\-ns$>$ \&traj); \-Input the trajectory from a stream 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{\-Returns}
the input stream template $<$typename \-T, int nx = \-Dynamic, int nu = \-Dynamic, int np = \-Dynamic, int \-\_\-ns = \-Dynamic$>$ std\-::istream\& operator$>$$>$(std\-::istream \&is, gcop\-::\-Trajectory$<$\-T, nx, nu, np, \-\_\-ns$>$ \&traj); 
\end{DoxyReturn}


\-References gcop\-::\-Trajectory$<$ T, nx, nu, np, \-\_\-ns $>$\-::s.
...
\-Referenced by gcop\-::\-Trajectory$<$ T, nx, nu, np, \-\_\-ns $>$\-::\-Trajectory().
...
\subsubsection[{ts}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , int nx = \-Dynamic, int nu = \-Dynamic, int np = \-Dynamic, int \-\_\-ns = \-Dynamic$>$ vector$<$double$>$ {\bf gcop\-::\-Trajectory}$<$ \-T, nx, nu, {\bf np}, \-\_\-ns $>$\-::{\bf ts}}\label{classgcop_1_1Trajectory_a5b96d4187cba8f4cbc69601728e1ffb3}
...
\subsubsection[{xs}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T , int nx = \-Dynamic, int nu = \-Dynamic, int np = \-Dynamic, int \-\_\-ns = \-Dynamic$>$ vector$<$\-T$>$ {\bf gcop\-::\-Trajectory}$<$ \-T, nx, nu, {\bf np}, \-\_\-ns $>$\-::{\bf xs}}\label{classgcop_1_1Trajectory_ab9f56dcc911ead31affe25cfdc7b048c}
...
\item 
lib/systems/parametrization/{\bf trajectory.\-h}\end{DoxyCompactItemize}
