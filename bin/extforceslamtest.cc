...
void Run(Viewer* viewer)
{
  ...
  Body2dGraph pgt(sys, N, nf, true, false, true);   ///< ground truth
  Body2dGraph pg(sys, N, nf, true, false, true);    ///< noisy pose graph  
  ...
  pgtv.rgba[0] = 0;   pgtv.rgba[1] = 1; pgtv.rgba[2] = 0;
  ...
  pgv.rgba[0] = 0; pgv.rgba[1] = 0; pgv.rgba[2] = 1;
