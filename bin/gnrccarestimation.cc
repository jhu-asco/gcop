...
void solver_process(Viewer* viewer)
{
  ...
  // cost
  LqSensorCost<Vector4d, 4, 2, Dynamic, 8, Vector3d, 3> cost(sys, gps.Z);
  ...
  VectorXd mup(1);//Initial Prior
  VectorXd p0(1);//Initial Guess
  ...
  GnDoep<Vector4d, 4, 2, Dynamic, 8, Vector3d, 3, Point3dState, 6> gn(sys, gps, cost, ts, xs, us, p0, &projectmanifold);  
  getchar();
  ...
  */
  ...
  gn.debug = true; // turn off debug for speed
  //getchar();
